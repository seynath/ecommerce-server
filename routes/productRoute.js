...
const {createProduct, getProduct,getProductCashier, getAllProducts,updateProduct, deleteProduct, addToWishlist, rating, getRating} = require('../controllers/productCtrl');
